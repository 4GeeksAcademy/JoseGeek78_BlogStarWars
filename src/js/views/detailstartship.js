...
export const DetailStartships = () => {
  ...
  useEffect(() => {
    ...
    if (idstartship != null) {
      ...
      const startshipData = store.startships.find(
        (item, index) => index == idstartship
      );
      if (startshipData) {
  ...
  return (
    <div className="contenedordetail col-md-10 mx-auto">
      <div className="contenedorimgdatos">
        <div className="imgdetail p-2 text-center fs-2 text text-secondary-emphasis">
          <p className="imgdet">800x600</p>
        </div>
        ...
        <table className="tabledescrip mt-3">
          <thead>
            <tr>
              ...
              <th scope="col">
                <p className="text-danger">
                  Max atmosphering<br></br>Speed
                </p>
              </th>
              <th scope="col">
                <p className="text-danger">
                  Cargo <br></br>Capacity
                </p>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td className="text-danger">
                {datastarship.max_atmosphering_speed}
              </td>
